...
function init() {
    ...
    const canvas = document.getElementById('notebookPaperCanvas') as HTMLCanvasElement;
    if (!canvas) {
...
const NotebookPaper: React.FC = () => {
    const canvasRef = useRef<HTMLCanvasElement>(null);

    useEffect(() => {
        if (canvasRef.current) {
            canvasRef.current.id = 'notebookPaperCanvas';
            init();

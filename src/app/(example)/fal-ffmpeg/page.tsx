...
import TextInput from '@/components/fabulous-minimovie/components/TextInput';
import * as fal from '@fal-ai/serverless-client';
import {  useState, useEffect } from 'react';
import Link from 'next/link';
import Ffmpeg from '@/components/fabulous-minimovie/sections/MovieDisplay';
import MovieDisplay from '@/components/fabulous-minimovie/sections/MovieDisplay';
import Hero from '@/components/fabulous-minimovie/sections/Hero';
import SceneEditor from '@/components/fabulous-minimovie/components/SceneEditor';
import SceneList from '@/components/fabulous-minimovie/sections/SceneList';

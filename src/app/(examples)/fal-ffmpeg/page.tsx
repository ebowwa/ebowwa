...
import TextInput from '@/components/(experimential)/fabulous-minimovie/components/TextInput';
import * as fal from '@fal-ai/serverless-client';
import {  useState, useEffect } from 'react';
import Link from 'next/link';
import Ffmpeg from '@/components/(experimential)/fabulous-minimovie/sections/MovieDisplay';
import MovieDisplay from '@/components/(experimential)/fabulous-minimovie/sections/MovieDisplay';
import Hero from '@/components/(experimential)/fabulous-minimovie/sections/Hero';
import SceneEditor from '@/components/(experimential)/fabulous-minimovie/components/SceneEditor';
import SceneList from '@/components/(experimential)/fabulous-minimovie/sections/SceneList';

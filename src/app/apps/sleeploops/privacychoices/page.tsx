...
export const metadata = {
  title: 'SleepLoops Privacy Choices - Ebowwa Labs',
  description: 'Manage your privacy preferences and data choices for the SleepLoops app',
};
  ...
  return (
    <div className="min-h-screen p-8 max-w-4xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          You can manage your data collection preferences directly in the SleepLoops app:
        </p>
        <ol className="list-decimal pl-6 space-y-4">
          <li>Open the SleepLoops app</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          To delete all your data from SleepLoops:
        </p>
        <ol className="list-decimal pl-6 space-y-4">
          <li>Open the SleepLoops app</li>

...
export const metadata = {
  ...
  description: 'Support information and help for Ebowwa app users',
};
    ...
    <div className="min-h-screen p-8 max-w-4xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-medium mb-2">How do I get started with Ebowwa?</h3>
            <p>Download Ebowwa from the App Store and follow the onboarding tutorial to set up your first sleep schedule.</p>
          </div>
          <div>
